...
console.groupCollapsed(
	`%c ⚡ SOLAR-OVERVIEW-CARD %c ${localize('common.version')}: ${CARD_VERSION} `,
	'color: white; font-weight: bold; background: #0b6e4f',
	'color: white; font-weight: bold; background: dimgray',
);
console.log('Readme:', 'https://github.com/xprezz/solar-overview-card');
console.log('Fork of:', 'https://github.com/slipx06/sunsynk-power-flow-card (MIT)');
console.groupEnd();
